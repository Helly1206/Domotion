...
####################### GLOBALS #########################
APPNAME = "Domotion"
LONGAPPNAME = "{} Home control and automation".format(APPNAME)
VERSION = "2.00"
ETCPATH = "/etc/Domotion"
XMLFILENAME = "DomoWeb.xml"
AVAILABLEPATH = "/etc/apache2/sites-available"
ENABLEDPATH = "/etc/apache2/sites-enabled"
WEBPATH = "/var/www/Domotion"
WSGIFILE = "{}/DomoWeb.wsgi".format(WEBPATH)
WEBSERVERNAME = ""
PREFIXNAME = "DomoWeb_prefix"
DIRECTNAME = "DomoWeb_direct"
DEBUG = False
