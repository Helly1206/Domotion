...
class Apache2Config(object):
    ...
    def PrereqInstalled(self):
        ...
        if (not IsInstalled):
            sys.exit("Package 'apache2' is not installed, run '/opt/apache2_install.sh -a' first or install manually")
        ...
        if (not IsInstalled):
            sys.exit("Package 'libapache2-mod-wsgi-py3' is not installed, run '/opt/apache2_install.sh -a' first or install manually")
